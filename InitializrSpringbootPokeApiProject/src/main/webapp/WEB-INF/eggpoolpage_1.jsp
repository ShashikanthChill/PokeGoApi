...
<html lang="en">
    <head>
        ...
        <script src="/js/eggpoolscripts.js"></script>
    </head>
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <div class="mx-auto order-0">
                <a class="navbar-brand mx-auto" href="#">Egg Pool Editor</a>
        ...
        <div class="container" style="margin-top: 75px;margin-bottom: 25px">
            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#insertModal">+ New Egg Entry</button>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header text-light bg-primary">
                            <h4 class="modal-title">Insert Egg Info</h4>
                        </div>
                        <!--body-->
                        <div class="modal-body">
                            <form method="post" action="submitegginfo" onsubmit="return validateInsertForm()">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Egg Distance:</label>
                                    <div class="col-sm-6">
                                        <select class="form-control custom-select" id="eggdistance" name="eggDistance">
            ...
            <div class="modal fade" id="updateModal" role="dialog" tabindex="-1">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header text-light bg-primary">
                            <center>
                                <h4 class="modal-title">Update Egg Info</h4>
                            </center>
                        </div>
                        <div class="modal-body">
                            <form method="post" action="updateegginfo" onsubmit="return validateUpdateForm()">
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Egg Distance:</label>
                                    <div class="col-sm-6">
                                        <select class="form-control custom-select" id="eggdistance_u" name="eggDistance">
                                            <option class="text-white bg-warning">
                                                Pick a distance
                                            </option>
                                            <option value="2">
