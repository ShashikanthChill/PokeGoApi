...
//@JsonPropertyOrder(value = {"pokeDex", "raidBoss", "type", "boostedWeather", "gen", "tier", "raidBossCp", "minCpNonBoosted", "maxCpNonBoosted", "minCpBoosted", "maxCpBoosted", "groupSizeDifficulty", "catchRate", "shinyAailable"})
...
//    @JsonProperty(value = "Shiny Availability")
    ...
    {
        return "RaidBossIncomingServiceModel{" + "pokeDex=" + pokeDex + ", raidBoss=" + raidBoss + ", type1=" + type1 + ", type2=" + type2 + ", tier=" + tier + ", gen=" + gen + ", raidBossCp=" + raidBossCp + ", minCpNonBoosted=" + minCpNonBoosted + ", maxCpNonBoosted=" + maxCpNonBoosted + ", minCpBoosted=" + minCpBoosted + ", maxCpBoosted=" + maxCpBoosted + ", groupSizeDifficulty=" + groupSizeDifficulty + ", catchRate=" + catchRate + ", shinyAvailable=" + shinyAvailable + '}';
    }
