...
public class TypeEffectivenessEntityModel implements Serializable
{
    ...
    public TypeEffectivenessEntityModel(Integer id, String type, double normal, double fire, double water, double electric, double grass, double ice, double fighting, double poison, double ground, double flying, double psychic, double bug, double rock, double ghost, double dragon, double dark, double steel, double fairy)
    {
        this.id = id;
        this.type = type;
        this.normal = normal;
